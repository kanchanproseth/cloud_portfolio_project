...
class AppColors {
  ...
  static const Color primaryColor = Color(0xFF482673);
  static const Color secondaryColor = Color.fromARGB(255, 249, 243, 248);
  static const Color accentColor = Color(0xFFed0b70);
  static const Color accentColor2 = Color.fromARGB(255, 245, 42, 133);
  static const Color accentColor3 = Color.fromARGB(255, 245, 118, 175);
  static const Color complimentColor1 = Color(0xFF000000);
  static const Color complimentColor2 = Color(0xffD8A7B1);
